...
CREATE TABLE `department` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_hodId_idx` (`hodId`),
  CONSTRAINT `fk_hodId` FOREIGN KEY (`hodId`) REFERENCES `doctor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `department` VALUES (1,'cardio',NULL),(2,'ortho',NULL),(3,'gynae',NULL);
