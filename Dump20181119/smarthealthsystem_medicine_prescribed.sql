...
CREATE TABLE `medicine_prescribed` (
  ...
  KEY `mid_idx` (`medicineId`),
  CONSTRAINT `mid` FOREIGN KEY (`medicineId`) REFERENCES `medicine` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pID` FOREIGN KEY (`recordID`) REFERENCES `record` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `medicine_prescribed` VALUES (25,32,2),(26,32,4),(27,32,3),(28,39,3),(29,39,5);
